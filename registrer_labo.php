...
// vérification de l'unicité de email :
  $email_verif = $mysqli->query("SELECT * FROM labo WHERE email = '$_POST[email]'");
...
// insertion en base :
    $mysqli->query("INSERT INTO labo (nom, nom_res, prenom_res, adresse, ville, cdp, pays, email, tel, statut, inscription, login, password, acceptation)

     VALUES ('$_POST[nom]','$_POST[nom_res]','$_POST[prenom_res]', '$_POST[adresse]', '$_POST[ville]','$_POST[cdp]','$_POST[pays]', '$_POST[email]','$_POST[tel]',0,NOW(),'$_POST[login]','$_POST[password]','$_POST[acceptation]')") or die($mysqli->error);
  ...
  <div class="tab-pane active" id="contact_details">
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-5">
         ...
         <input type="text" name="prenom_res" id="prenom_res" class="form-control" style="text-transform: capitalize;" placeholder="Prenom du responsable"/>
      ...
      <div class="form-group col-md-3">
         <!--<label>Enter Nom du laboratoire </label> -->
         <input type="text" name="nom" id="nom" class="form-control"  placeholder="Nom du laboratoire"/>
      ...
      <div class="form-row">
        ...
        <div class="form-group col-md-3"> 
         ...
         <input type="text" name="tel" id="tel" class="form-control" s placeholder="Telephone"/>
...
$(document).ready(function(){
  ...
  {
   error_nom = 'Nom du laboratoire requis ';
  ...
  {
   error_prenom_res= 'Prénom est requis';
