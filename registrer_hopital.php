...
// vérification de l'unicité de email :
  $email_verif = $mysqli->query("SELECT * FROM hopital WHERE email_dir = '$_POST[email_dir]'");
...
// insertion en base :
    $mysqli->query("INSERT INTO hopital (hopital, adresse, ville, cdp, pays, nom_dir, prenom_dir, email_dir, tel_dir, statut, inscription, login,  password, acceptation)

     VALUES ('$_POST[hopital]','$_POST[adresse]','$_POST[ville]', '$_POST[cdp]', '$_POST[pays]','$_POST[nom_dir]','$_POST[prenom_dir]', '$_POST[email_dir]','$_POST[tel_dir]',0, NOW(),'$_POST[login]','$_POST[password]','$_POST[acceptation]')") or die($mysqli->error);
 ...
 <br />
  ...
  <div class="form-row">
    <div class="form-group col-md-5">
         <!--<label>Enter hopital </label> -->
         <input type="text" name="hopital" id="hopital" class="form-control"  placeholder="Nom de l'hopital"/>
         <span id="error_hopital" class="text-danger"></span>
        </div>

        <div class="form-group col-md-5">
         <!-- <label>Enter adresse</label> -->
         <input type="text" name="adresse" id="adresse" class="form-control"  placeholder="Adresse de l'hopital "/>
...
$(document).ready(function(){
  ...
  {
   error_hopital = 'Nom hopital requis ';
  ...
  if(error_hopital != '' ||  error_adresse != '' || error_ville != '' || error_cdp != '' || error_pays != '' || error_nom_dir != '' || error_prenom_dir!= '' ||error_email_dir != '' || error_tel_dir != '') 
  {
   return false;
  }
  else
