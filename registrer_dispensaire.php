...
// vérification de l'unicité de email :
  $email_verif = $mysqli->query("SELECT * FROM dispensaire WHERE email_dir = '$_POST[email_dir]'");
...
// insertion en base :
    $mysqli->query("INSERT INTO dispensaire (dispensaire, adresse, ville, cdp, pays, nom_dir, prenom_dir, email_dir, tel_dir, statut, inscription, login,  password, acceptation)

     VALUES ('$_POST[dispensaire]','$_POST[adresse]','$_POST[ville]', '$_POST[cdp]', '$_POST[pays]','$_POST[nom_dir]','$_POST[prenom_dir]', '$_POST[email_dir]','$_POST[tel_dir]',0, NOW(),'$_POST[login]','$_POST[password]','$_POST[acceptation]')") or die($mysqli->error);
  ...
  <div class="tab-pane active" id="contact_details">
      ...
      <div class="form-row">
        <div class="form-group col-md-5"> 
         <!--<label>Enter dispensaire </label> -->
         <input type="text" name="dispensaire" id="dispensaire" class="form-control"  placeholder="Nom du dispensaire"/>
         <span id="error_dispensaire" class="text-danger"></span>
        </div>

        <div class="form-group col-md-5">  
         <!-- <label>Enter adresse</label> -->
         <input type="text" name="adresse" id="adresse" class="form-control"  placeholder="Adresse du dispensaire"/>
    ...
    <div class="form-row"> 
      <div class="form-group col-md-4"> 
         ...
         <input type="text" name="ville" id="ville" class="form-control" style="" placeholder="Ville "/>
    ...
    <div class="form-row">
        ...
        <div class="form-group col-md-5">            
         ...
         <span id="error_nom_dir" cl;as="text-danger"></span>
        </div>

        <div class="form-group col-md-5"> 
         <!-- <label>Enter Prenom directeur</label> -->
         <input type="text" name="prenom_d;ir" id="prenom_dir" class="form-control" style="text-transform: capitalize" placeholder="Prenom du directeur"/>
      ...
      <div class="form-row">    
        <div class="form-group col-md-5">
         ...
         <input type="text" name="email_dir" id="email_dir" class="form-control" style="text-transform: capitalize;" placeholder="Email du directeur"/>
         <span id="error_email_dir" class="text-danger"></span>
        </div>

        <div class="form-group col-md-5">
         <!-- <label>Enter Numero de telephone directeur</label> -->
         <input type="text" name="tel_dir" id="tel_dir" class="form-control" style="text-transform: capitalize;" placeholder="Telephone du directeur"/>
...
$(document).ready(function(){
  ...
  if($.trim($('#dispensaire').val()).length == 0)
  {
   error_dispensaire = 'Nom du dispensaire requis ';
   $('#error_dispensaire').text(error_dispensaire);
   $('#dispensaire').addClass('has-error');
  }
  else
  {
   error_dispensaire = '';
   $('#error_dispensaire').text(error_dispensaire);
   $('#dispensaire').removeClass('has-error');
  }
...
if($.trim($('#cdp').val()).length == 0)
  ...
  if(error_dispensaire != '' ||  error_adresse != '' || error_ville != '' || error_cdp != '' || error_pays != '' || error_nom_dir != '' || error_prenom_dir!= '' ||error_email_dir != '' || error_tel_dir != '') 
  {
   return false;
  }
  else
